...
const stats = [
  ...
  },
  {
    id: 'opensource',
    label: 'Open Source',
    sublabel: 'GitHub Contributions',
    value: '500+',
    note: 'Commits across personal & OSS projects',
    color: '#10b981',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-14">
        {stats.map((stat, i) => (
          ...
          >
            ...
            <div className="text-[#475569] text-xs leading-relaxed border-t border-white/[0.05] pt-3">
              {stat.note}
            </div>
          </div>
        ))}
