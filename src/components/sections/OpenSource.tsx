...
export const ossContributions = [
  {
    id: 'oss-1',
    repo: 'mdn/content',
    repoUrl: 'https://github.com/mdn/content',
    stars: '⭐ 10.6k',
    prTitle: 'Docs: Tweak operator precedence example',
    prTag: '#41251',
    prUrl: 'https://github.com/mdn/content/pull/41251#issuecomment-3320649472',
    type: 'PR',
  },
  {
    id: 'oss-2',
    repo: 'devopness/devopness',
    repoUrl: 'https://github.com/devopness/devopness',
    stars: '⭐ 358',
    prTitle: 'docs: rename Steps to Pipeline Steps',
    prTag: '#1237',
    prUrl: 'https://github.com/devopness/devopness/pull/1237',
    type: 'PR',
  },
  {
    id: 'oss-3',
    repo: 'abhisek247767/PeopleHub-Frontend',
    repoUrl: 'https://github.com/abhisek247767/PeopleHub-Frontend',
    stars: '⭐ 19',
    prTitle: 'fix(ui): UI Issue',
    prTag: '#136',
    prUrl: 'https://github.com/abhisek247767/PeopleHub-Frontend/pull/136#event-19780063703',
    type: 'PR',
  },
  {
    id: 'oss-4',
    repo: 'DollhouseMCP/mcp-server',
    repoUrl: 'https://github.com/DollhouseMCP/mcp-server',
    stars: '⭐ 28',
    prTitle: 'perf: Optimize whitespace detection and enhance path validation',
    prTag: '#1037',
    prUrl: 'https://github.com/DollhouseMCP/mcp-server/pull/1037#event-19816697965',
    type: 'PR',
  },
  {
    id: 'oss-5',
    ...
    repoUrl: 'https://github.com/DollhouseMCP/mcp-server',
    stars: '⭐ 28',
    prTitle: 'Release v1.9.6 - First External Contribution 🎉',
    prTag: '#1039',
    prUrl: 'https://github.com/DollhouseMCP/mcp-server/pull/1039#event-19816885986',
    type: 'PR',
  },
  {
    id: 'oss-6',
    repo: 'martinfrancois/question-driven-talk-assistant',
    repoUrl: 'https://github.com/martinfrancois/question-driven-talk-assistant',
    stars: '⭐ 5',
    prTitle: 'refactor(qr): extract qr code size constants and improve resize handler',
    prTag: '#607',
    prUrl: 'https://github.com/martinfrancois/question-driven-talk-assistant/pull/607',
    type: 'PR',
  },
  {
    id: 'oss-7',
    repo: 'OFFER-HUB/offer-hub',
    repoUrl: 'https://github.com/OFFER-HUB/offer-hub',
    stars: '⭐ N/A',
    prTitle: 'Re: [OFFER-HUB/offer-hub] feat(ui): add loading state to button component',
    prTag: '#699',
    prUrl: 'https://github.com/OFFER-HUB/OFFER-HUB/issues/699#event-19955524154',
    type: 'Issue',
  },
];
